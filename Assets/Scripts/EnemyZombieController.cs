...
public class EnemyZombieController : MonoBehaviour {
    ...
    [Header("Detection")]
    [SerializeField] private float m_detectionRange = 8f;   // zasiêg zauwa¿enia
    [SerializeField] private float m_loseRange = 12f;        // zasiêg zgubienia
    ...
    [SerializeField] private float m_alertedLookAroundTime = 2f; // ile czeka po dotarciu
    ...
    private void OnDrawGizmos() {
        ...
        switch (m_state) {
            ...
            case ZombieState.Alerted:
                // pomarañczowy — wiêkszy zasiêg wykrywania
            ...
            case ZombieState.Chase:
                // czerwony okr¹g zasiêgu zgubienia
                Gizmos.color = Color.red;
...
#if UNITY_EDITOR
        // etykieta z aktualnym stanem nad zombie
    ...
    private bool CanSeePlayer() {
        ...
        if (m_state == ZombieState.Chase) {
            ...
            // Alerted ma wiêkszy zasiêg wykrywania
    ...
    private void UpdateChase() {
        Vector2 dir = (Vector2) m_player.position - (Vector2) transform.position;
        RotateTowards(dir);
        m_rb.linearVelocity = dir.normalized * m_chaseSpeed;
    }

    private void UpdateAlerted() {
        Vector2 dir = m_alertTarget - (Vector2) transform.position;
        ...
        RotateTowards(dir);
        m_rb.linearVelocity = dir.normalized * m_alertedSpeed;
    }
